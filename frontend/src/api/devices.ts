...
export const TUBE_MODELS = [
  { value: 0, label: '1×1', innerDiameterMm: 1, maxFlow: 7.55 },
  { value: 1, label: '2×1', innerDiameterMm: 2, maxFlow: 27.52 },
  { value: 2, label: '2.4×0.86', innerDiameterMm: 2.4, maxFlow: 38.13 },
  { value: 3, label: '3×1', innerDiameterMm: 3, maxFlow: 48.38 },
  { value: 4, label: '0.13×0.86', innerDiameterMm: 0.13, maxFlow: 0.29 },
  { value: 5, label: '0.19×0.86', innerDiameterMm: 0.19, maxFlow: 0.44 },
  { value: 6, label: '0.25×0.86', innerDiameterMm: 0.25, maxFlow: 0.76 },
  { value: 7, label: '0.51×0.86', innerDiameterMm: 0.51, maxFlow: 2.00 },
  { value: 8, label: '0.89×0.86', innerDiameterMm: 0.89, maxFlow: 4.47 },
  { value: 9, label: '1.14×0.86', innerDiameterMm: 1.14, maxFlow: 9.16 },
  { value: 10, label: '1.42×0.86', innerDiameterMm: 1.42, maxFlow: 18.75 },
  { value: 11, label: '1.52×0.86', innerDiameterMm: 1.52, maxFlow: 22.0 },
  { value: 12, label: '2.06×0.86', innerDiameterMm: 2.06, maxFlow: 29.60 },
  { value: 13, label: '2.79×0.86', innerDiameterMm: 2.79, maxFlow: 42.86 },
] as const
